...
const places = [
  {
    name: 'Tirupati',
    image: 'https://s7ap1.scene7.com/is/image/incredibleindia/tirumala-venkateswara-temple-tirupati-andhra-pradesh-city-ff?qlt=82&ts=1742150827046',
  },
  {
    name: 'Bengaluru',
    image: 'https://d1di04ifehjy6m.cloudfront.net/media/filer_public/7a/23/7a230dbe-215f-4144-9810-60f94e51116c/adobestock_835040940_2.png',
  },
  {
    name: 'Coimbatore',
  ...
  {
    name: 'Madikeri',
    image: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/13/78/2c/57/abbey-falls.jpg?w=500&h=500&s=1',
  },
  {
    name: 'Ooty',
